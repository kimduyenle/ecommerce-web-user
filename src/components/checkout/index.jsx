...
import icon1 from 'assets/images/payment-icon/1.png';
import icon2 from 'assets/images/payment-icon/2.png';
import icon3 from 'assets/images/payment-icon/3.png';
import icon4 from 'assets/images/payment-icon/5.png';
import icon5 from 'assets/images/payment-icon/7.png';
                        ...
                        <form className="needs-validation" noValidate>
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    ...
                                    <input type="text" className="form-control" id="firstName" placeholder="" value="" onChange={() => {}} required />
                                    <div className="invalid-feedback"> Valid first name is required. </div>
                                </div>
                                <div className="col-md-6 mb-3">
                                    <label htmlFor="lastName">Last name *</label>
                                    <input type="text" className="form-control" id="lastName" placeholder="" value="" onChange={() => {}} required />
                            ...
                            <div className="d-block my-3">
                                <div className="custom-control custom-radio">
                                    <input id="credit" name="paymentMethod" type="radio" className="custom-control-input" checked onChange={() => {}} required />
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6 mb-3">
                                    <div className="payment-icon">
                                        <ul>
                                            <li><img className="img-fluid" src={icon1} alt="" /></li>
                                            <li><img className="img-fluid" src={icon2} alt="" /></li>
                                            <li><img className="img-fluid" src={icon3} alt="" /></li>
                                            <li><img className="img-fluid" src={icon4} alt="" /></li>
                                            <li><img className="img-fluid" src={icon5} alt="" /></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="row">
                        <div className="col-md-12 col-lg-12">
                            <div className="shipping-method-box">
                                ...
                                <div className="mb-4">
                                    <div className="custom-control custom-radio">
                                        <input id="shippingOption1" name="shipping-option" className="custom-control-input" checked="checked" type="radio" onChange={() => {}} />
                                        <label className="custom-control-label" htmlFor="shippingOption1">Standard Delivery</label> <span className="float-right font-weight-bold">FREE</span> </div>
                                    ...
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="shippingOption2">Express Delivery</label> <span className="float-right font-weight-bold">$10.00</span> </div>
                                    ...
                                    <div className="custom-control custom-radio">
                                        ...
                                        <label className="custom-control-label" htmlFor="shippingOption3">Next Business day</label> <span className="float-right font-weight-bold">$20.00</span> </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-12 col-lg-12">
